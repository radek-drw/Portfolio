...
function updateSkillsAndDots() {
  ...
  activeSkills.forEach((skill) => skill.classList.remove('skills__list-item--active'));
  ...
  const dots = document.querySelectorAll('.skills__list-progress-bar > .progress-bar-dot');
